...
static inline std::string TrimLeadingWhitespace(const std::string& str) {
...
static inline std::string ToStringWithPrecision(const float a_value, const int n = 2) {
...
static inline int readLabels(const std::string labels_filename, std::unordered_map<int, std::string>& labels_map) {
